...
public class NFasDataNew4 extends Configured implements Tool
{
		...
		public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
			...
			for (int k0=1;k0<=u;k0++) {
				...
				for (int i=0;i<m.length-k0+1;i++) {
					...
					if (checkm1.contains(m1) /*|| !(m1.equals("을를/JKO")) || !(m1.equals("은는/JX"))  || !(m1.equals("그/NP"))*/ /*|| !(m1.equals("교수/NNG")) || !(m1.equals("동물/NNG"))*/|| !(m1.equals("은는/ETM"))) continue;
					else checkm1.add(m1);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new NFasDataNew4(), args);
		System.exit(res);
	}
	...
	public int run(String[] args) throws Exception
	{
		...
		job.setJarByClass(NFasDataNew4.class);
